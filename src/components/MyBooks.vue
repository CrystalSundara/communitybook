            ...
            <div class="row no-gutters">
              ...
              <div class="col-8">
                <div class="card-body d-flex flex-column ml-3" style="height: 150px;">
                  ...
                  <div class="mt-auto">
                  <a @click="removeMyBookslist(book)" href="#" class="card-link interactive mr-2 small"><i class="typcn typcn-minus" style="font-size: 1rem;"></i>My books</a>
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    removeMyBookslist: function (book) {
